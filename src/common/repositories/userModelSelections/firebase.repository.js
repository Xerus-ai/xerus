...
async function get(uid) {
    try {
        ...
        logger.error('Error getting user model selections:', { error });
        return null;
    }
}
...
async function upsert(uid, selections) {
    try {
        ...
        logger.error('Error upserting user model selections:', { error });
        throw error;
    }
}
...
async function remove(uid) {
    try {
        ...
        logger.error('Error removing user model selections:', { error });
        throw error;
    }
}
