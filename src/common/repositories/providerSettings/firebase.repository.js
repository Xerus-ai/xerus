...
async function upsert(uid, provider, settings) {
    try {
        ...
        logger.error('Error upserting provider settings:', { error });
        throw error;
    }
}
...
async function remove(uid, provider) {
    try {
        ...
        logger.error('Error removing provider settings:', { error });
        throw error;
    }
}
...
async function removeAllByUid(uid) {
    try {
        ...
        logger.error('Error removing all provider settings:', { error });
        throw error;
    }
}
