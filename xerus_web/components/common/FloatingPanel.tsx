            ...
            {isOpen && (
                isMinimized ? (
                    <motion.div
                        ...
                        className="fixed bottom-6 z-50 bg-text text-white rounded-xl shadow-lg cursor-pointer hover:bg-text/90 flex items-center gap-3 px-4 py-3 w-[220px] max-w-[calc(100vw-2rem)]"
                    ...
                    <motion.div
                        ...
                        className={cn(
                            ...
                            variant === 'default' ? "bg-surface-alt" : "bg-card",
                            className
                        )}
                    >
                        {variant === 'default' ? (
