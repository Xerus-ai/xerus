  ...
  return (
    <span className="inline-flex items-center gap-[3px] ml-0.5" aria-hidden="true">
      {[0, 0.2, 0.4].map((delay, i) => (
        <span
          key={i}
          className={cn('w-1 h-1 rounded-full bg-[#FF6600]', animClass)}
...
export function ThinkingIndicator({
  ...
  return (
    <span className="inline-flex items-center gap-1.5 text-[14px] text-text-secondary">
      {!isError && (
        <svg className="w-3.5 h-3.5 text-[#FF6600] animate-thinking-breathe shrink-0" fill="currentColor" fillRule="evenodd" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
