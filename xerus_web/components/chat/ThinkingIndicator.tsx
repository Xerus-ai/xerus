  ...
  return (
    <span className="inline-flex items-center gap-[3px] ml-0.5" aria-hidden="true">
      {[0, 0.2, 0.4].map((delay, i) => (
        <span
          key={i}
          className={cn('w-1 h-1 rounded-full bg-secondary', animClass)}
...
export function ThinkingIndicator({
  ...
  return (
    <span data-testid="thinking-indicator" className="inline-flex items-center gap-1.5 text-[14px] text-text-secondary">
      {!isError && (
