  ...
  return (
    <div>
      ...
      >
        ...
        {isDir ? (
          isExpanded ? (
            <FolderOpen className="w-4 h-4 shrink-0 text-secondary/70" />
          ) : (
            <Folder className="w-4 h-4 shrink-0 text-secondary/70" />
          )
        ) : (
        ...
        <span className="flex items-center gap-1.5 shrink-0">
          ...
          {isUploadable && onUploadClick && (
            <button
              ...
              className="w-4 h-4 rounded flex items-center justify-center text-text-muted hover:text-secondary hover:bg-secondary/10 transition-colors opacity-0 group-hover:opacity-100"
              title="Upload file"
            >
