  ...
  return (
    ...
    >
        ...
        <button
          ...
          className={cn(
            ...
            priorityFilter === p
              ...
              : 'bg-surface text-text-secondary hover:text-text hover:bg-surface-pressed'
          )}
        >
      ...
      <Popover>
        ...
        <PopoverContent className="w-56 p-2 bg-card border border-surface-active rounded-xl shadow-lg" align="start">
          <div className="max-h-[260px] overflow-y-auto">
            ...
            >
              <div className={cn(
                ...
                agentFilter === 'all' ? 'bg-text border-text' : 'border-surface-active'
              )}>
            ...
            {agents.map((a) => (
              ...
              >
                <div className={cn(
                  'w-4 h-4 rounded border flex items-center justify-center flex-shrink-0',
                  agentFilter === a.slug ? 'bg-text border-text' : 'border-surface-active'
                )}>
            ...
            <div className="max-h-[260px] overflow-y-auto">
              {projects.map((d) => (
                ...
                >
                  <div className={cn(
                    'w-4 h-4 rounded border flex items-center justify-center flex-shrink-0',
                    domainFilter === d ? 'bg-text border-text' : 'border-surface-active'
                  )}>
